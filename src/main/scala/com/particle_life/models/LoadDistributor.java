...
public class LoadDistributor {
    ...
    //public record BatchProcessor(int start, int stop, IndexProcessor indexProcessor) implements Runnable {
    public class BatchProcessor implements Runnable {
        //(int start, int stop, IndexProcessor indexProcessor)
        private int start;
        private int stop;
        private IndexProcessor indexProcessor;

        BatchProcessor(int start, int stop, IndexProcessor indexProcessor) {
            this.start = start;
            this.stop = stop;
